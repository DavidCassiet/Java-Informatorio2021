...
public class Exercise05 {
    ...
    public static void main(String[] args) {
        ...
        workedHours.add(6); workedHours.add(7); workedHours.add(8); workedHours.add(4); workedHours.add(5);
        valuePerHour.add(350); valuePerHour.add(345); valuePerHour.add(550); valuePerHour.add(600); valuePerHour.add(320);
        int totalAmount= 0;
        int total= 0;
        ...
        System.out.println(listTotals); System.out.println("Final total: $" + total);
    }
}